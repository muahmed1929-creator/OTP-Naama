...
import { Lock, Mail, RefreshCw, ArrowRight } from 'lucide-react';
...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      localStorage.setItem('otp_api_key', res.data.apiKey);
      localStorage.setItem('otp_user', JSON.stringify(res.data.user));
      router.push('/');
    } catch (err: any) {
